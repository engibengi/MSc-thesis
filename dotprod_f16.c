...
#include "dotprod_f16.h"

extern "C" _Float16* dotprod(_Float16 *A, _Float16 *B, _Float16 *C);
...
int main() {
  ...
  _Float16 *local_A = (_Float16 *)snrt_l1_next();
  _Float16 *local_B = local_A + EL;
  _Float16 *local_C = local_B + EL;
  _Float16 *local_D = local_C + 1;   
  ...
  if (snrt_is_dm_core()) {
    snrt_dma_start_1d(local_A, (volatile void *)A, EL * sizeof(_Float16));
    snrt_dma_start_1d(local_B, (volatile void *)B, EL * sizeof(_Float16));
    snrt_dma_start_1d(local_C, (volatile void *)C,  1 * sizeof(_Float16));
    snrt_dma_start_1d(local_D, (volatile void *)D,  1 * sizeof(_Float16));
    snrt_dma_wait_all();
  }
...
hb2:
  ...
  if(this_core != C_C) goto hb3;
    ...
    // Correctness check
    double d = fabs(local_C[0] - local_D[0]);
