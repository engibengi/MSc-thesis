...
int main() {
  ...
  _Float16 *local_B = local_A + I * J;
  _Float16 *local_C = local_B + K * J;
  _Float16 *local_D = local_C + I * K;   
  ...
  if (snrt_is_dm_core()) {
    snrt_dma_start_1d(local_A, (volatile void *)A, I * J * sizeof(_Float16));
    snrt_dma_start_1d(local_B, (volatile void *)B, K * J * sizeof(_Float16));
    snrt_dma_start_1d(local_C, (volatile void *)C, I * K * sizeof(_Float16));
    snrt_dma_start_1d(local_D, (volatile void *)D, I * K * sizeof(_Float16));
    snrt_dma_wait_all();
  }
