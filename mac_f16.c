...
int main() {
  ...
  _Float16 *local_B = local_A + EL * EL;
  _Float16 *local_C = local_B + EL * EL;
  _Float16 *local_D = local_C + EL * EL;   
  ...
  if (snrt_is_dm_core()) {
    snrt_dma_start_1d(local_A, (volatile void *)A, EL * EL * sizeof(_Float16));
    snrt_dma_start_1d(local_B, (volatile void *)B, EL * EL * sizeof(_Float16));
    snrt_dma_start_1d(local_C, (volatile void *)C, EL * EL * sizeof(_Float16));
    snrt_dma_start_1d(local_D, (volatile void *)D, EL * EL * sizeof(_Float16));
    snrt_dma_wait_all();
  }
